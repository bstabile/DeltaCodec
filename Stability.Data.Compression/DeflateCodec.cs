...
{
    /// <summary>
    /// This codec is a pass-through implementation that will only perform "finishing"
    /// compression on the data. The <see cref="NullTransform"/> will simply pass the
    /// data along to <see cref="DeflateStream"/>.
    /// </summary>
    public sealed class DeflateCodec : DeltaCodec<NullTransform>
    {
        #region Constructors

        /// <summary>
        /// This codec is basically just a wrapper around the <see cref="DeflateStream"/>
        /// compression facility built into the BCL. The <see cref="NullTransform"/> does not do any
        /// "Delta" processing of the data before passing it to the finisher. It is mainly useful for
        /// comparison testing against other more useful codecs.
        /// 
        ...
        /// included with the core library. When you derive your own types, be sure to pick 
        /// something with licensing appropriate to your situation. The third-party finishers 
        /// included are selected because of their fairly liberal open-source permissions.
        /// 
        ...
        /// </param>
        internal DeflateCodec(IFinisher defaultFinisher)
        ...
        /// to reuse a single codec when there is any kind of more complicated setup logic.
        /// </summary>
        static DeflateCodec()
        {
            Instance = new DeflateCodec();
        }

        public static DeflateCodec Instance { get; protected set; }
