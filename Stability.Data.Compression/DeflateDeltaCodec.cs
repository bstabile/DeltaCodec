...
namespace Stability.Data.Compression
{
    public sealed class DeflateDeltaCodec : DeltaCodec<DeltaTransform>
    {
        /// <summary>
        ...
        /// </param>
        internal DeflateDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static DeflateDeltaCodec()
        {
            Instance = new DeflateDeltaCodec();
        }

        public static DeflateDeltaCodec Instance { get; protected set; }
