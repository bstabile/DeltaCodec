...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpBZip2Codec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal SharpBZip2Codec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpBZip2Codec()
        {
            Instance = new SharpBZip2Codec();
        }

        public static SharpBZip2Codec Instance { get; protected set; }
