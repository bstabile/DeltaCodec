...
// FileName  : SharpGZipDeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpGZipDeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private SharpGZipDeltaCodec()
            : this(SharpGZipFinisher.Instance)
        {
        }
        ...
        /// </param>
        internal SharpGZipDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpGZipDeltaCodec()
        {
            Instance = new SharpGZipDeltaCodec();
        }

        public static SharpGZipDeltaCodec Instance { get; protected set; }
