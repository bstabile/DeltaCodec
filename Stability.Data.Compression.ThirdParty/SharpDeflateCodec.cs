...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpDeflateCodec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal SharpDeflateCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpDeflateCodec()
        {
            Instance = new SharpDeflateCodec();
        }

        public static SharpDeflateCodec Instance { get; protected set; }
