...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicZlibCodec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal IonicZlibCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicZlibCodec()
        {
            Instance = new IonicZlibCodec();
        }

        public static IonicZlibCodec Instance { get; protected set; }
