...
// FileName  : IonicDeflateDeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicDeflateDeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private IonicDeflateDeltaCodec()
            : this(IonicDeflateFinisher.Instance)
        {
        }
        ...
        /// </param>
        internal IonicDeflateDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicDeflateDeltaCodec()
        {
            Instance = new IonicDeflateDeltaCodec();
        }

        public static IonicDeflateDeltaCodec Instance { get; protected set; }
