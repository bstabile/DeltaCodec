...
// FileName  : SharpDeflateDeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpDeflateDeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private SharpDeflateDeltaCodec()
            : this(SharpDeflateFinisher.Instance)
        {
        }
        ...
        /// </param>
        internal SharpDeflateDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpDeflateDeltaCodec()
        {
            Instance = new SharpDeflateDeltaCodec();
        }

        public static SharpDeflateDeltaCodec Instance { get; protected set; }
