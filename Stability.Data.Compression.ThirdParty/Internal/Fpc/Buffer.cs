 ...
 */
    ...
    internal abstract class BufferBase
    {
        ...
        //
        protected BufferBase(int mark, int pos, int lim, int cap)
        {
            // package-private
            if (cap < 0)
     ...
     */
        ...
        public BufferBase Position(int newPosition)
        {
     ...
     */
        ...
        public BufferBase Limit(int newLimit)
        {
