...
using Stability.Data.Compression.ThirdParty.Internal.SharpZipLib.Checksums;
using Stability.Data.Compression.ThirdParty.Internal.SharpZipLib.Zip;
using Stability.Data.Compression.ThirdParty.Internal.SharpZipLib.Zip.Streams;
...
namespace Stability.Data.Compression.ThirdParty.Internal.SharpZipLib.GZip 
{
    ...
    /// using System.IO;
    /// 
    /// using Stability.Data.Compression.SharpZipLib.GZip;
    /// using Stability.Data.Compression.SharpZipLib.Core;
    /// 
    /// class MainClass
    /// {
    ...
    internal class GZipOutputStream : DeflaterOutputStream
    {
        ...
        /// The stream to read data (to be compressed) from
        /// </param>
        /// <param name="deflater">This is primarily useful to set the desired compression level.</param>
        /// <param name="size">
        /// Size of the buffer to use
        /// </param>
        public GZipOutputStream(Stream baseOutputStream, Deflater deflater, int size = 4096)
