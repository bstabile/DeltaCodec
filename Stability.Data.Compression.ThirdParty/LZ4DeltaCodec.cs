...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class LZ4DeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </param>
        public LZ4DeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static LZ4DeltaCodec()
        {
            Instance = new LZ4DeltaCodec();
        }

        public static LZ4DeltaCodec Instance { get; protected set; }
