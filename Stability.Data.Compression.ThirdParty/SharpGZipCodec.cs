...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpGZipCodec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal SharpGZipCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpGZipCodec()
        {
            Instance = new SharpGZipCodec();
        }

        public static SharpGZipCodec Instance { get; protected set; }
