...
// FileName  : SharpBZip2DeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class SharpBZip2DeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private SharpBZip2DeltaCodec()
            : this(SharpBZip2Finisher.Instance)
        {
        }
        ...
        /// </param>
        internal SharpBZip2DeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static SharpBZip2DeltaCodec()
        {
            Instance = new SharpBZip2DeltaCodec();
        }

        public static SharpBZip2DeltaCodec Instance { get; protected set; }
