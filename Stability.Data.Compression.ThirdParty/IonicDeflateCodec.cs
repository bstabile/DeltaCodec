...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicDeflateCodec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal IonicDeflateCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicDeflateCodec()
        {
            Instance = new IonicDeflateCodec();
        }

        public static IonicDeflateCodec Instance { get; protected set; }
