...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class QuickLZDeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private QuickLZDeltaCodec()
            : this(QuickLZFinisher.Instance)
        {
        }
        ...
        /// </param>
        internal QuickLZDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static QuickLZDeltaCodec()
        {
            Instance = new QuickLZDeltaCodec();
        }

        public static QuickLZDeltaCodec Instance { get; protected set; }
