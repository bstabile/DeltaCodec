...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicBZip2Codec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal IonicBZip2Codec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicBZip2Codec()
        {
            Instance = new IonicBZip2Codec();
        }

        public static IonicBZip2Codec Instance { get; protected set; }
