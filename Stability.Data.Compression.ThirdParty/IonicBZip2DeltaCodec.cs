...
// FileName  : IonicBZip2DeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicBZip2DeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        private IonicBZip2DeltaCodec()
            : this(IonicBZip2Finisher.Instance)
        {
        }
        ...
        /// </param>
        internal IonicBZip2DeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicBZip2DeltaCodec()
        {
            Instance = new IonicBZip2DeltaCodec();
        }

        public static IonicBZip2DeltaCodec Instance { get; protected set; }
