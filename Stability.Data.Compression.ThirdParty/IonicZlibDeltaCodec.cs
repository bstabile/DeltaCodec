...
// FileName  : IonicZlibDeltaCodec.cs
// Created   : 2015-4-25
...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class IonicZlibDeltaCodec : DeltaCodec<DeltaTransform>
    {
        #region Constructors
        ...
        /// </summary>
        public IonicZlibDeltaCodec()
            : this(IonicZlibFinisher.Instance)
        {
        }
        ...
        /// </param>
        public IonicZlibDeltaCodec(IFinisher defaultFinisher)
        ...
        /// </remarks>
        static IonicZlibDeltaCodec()
        {
            Instance = new IonicZlibDeltaCodec();
        }

        public static IonicZlibDeltaCodec Instance { get; protected set; }
