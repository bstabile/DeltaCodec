...
namespace Stability.Data.Compression.ThirdParty
{
    public sealed class QuickLZCodec : DeltaCodec<NullTransform>
    {
        #region Constructors
        ...
        /// </param>
        internal QuickLZCodec(IFinisher defaultFinisher)
        ...
        static QuickLZCodec()
        {
            Instance = new QuickLZCodec();
        }

        public static QuickLZCodec Instance { get; protected set; }
